...
- CloudCompare normals use an existing non-symlink parent, private staging, source and directory identity checks, and atomic no-clobber publication; they never write directly to the requested destination.
