...
- Exercise the corrected normals tool with LS, QUADRIC, and TRIANGULATION models, including automatic and explicit source-coordinate-unit radii, then verify each output contains normals.
