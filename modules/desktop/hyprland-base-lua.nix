# Plats: modules/desktop/hyprland-base-lua.nix
# Delad Lua-konfigurationssträng för Hyprland (bas)
# Importeras av hyprland-base.nix och host-specifika hyprland.nix
